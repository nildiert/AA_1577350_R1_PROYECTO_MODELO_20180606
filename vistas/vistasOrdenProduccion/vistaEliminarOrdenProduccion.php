...
<div class="d-flex justify-content-center  mb-3">
    <div class="card col-lg-3 ">
        ...
        <div class="card-title">
            <h3 class="panel-title">Eliminación de Venta</h3>
        </div>
    ...
    <form role="form" method="POST" action="controladores/ControladorPrincipal.php" id="formRegistro">
                        <input class="form-control" placeholder="OrdPId" name="OrdPId" type="TEXT" pattern="" required="required" autofocus readonly="readonly"
                            value="<?php
                            if (isset($eliminarDatosProductos->OrdPId))
                                echo $eliminarDatosProductos->OrdPId;
                        ...
                        <!--<p class="help-block">Example block-level help text here.</p>-->
                 <br>
                        <input class="form-control" placeholder="OrdPCant" name="OrdPCant" type="text"  required="required" readonly="readonly"
                            value="<?php
                            if (isset($eliminarDatosProductos->OrdPCant))
                                echo $eliminarDatosProductos->OrdPCant;                            
                            ...
                            <br>
                        <input class="form-control" placeholder="OrdPAsignada" name="OrdPAsignada" type="text"  required="required" readonly="readonly"
                            value="<?php
                            if (isset($eliminarDatosProductos->OrdPAsignada))
                                echo $eliminarDatosProductos->OrdPAsignada;                            
                            ...
                            <br>
                        <input class="form-control" placeholder="OrdPFecha" name="OrdPFecha" type="number"  required="required" readonly="readonly"
                            value="<?php
                            if (isset($eliminarDatosProductos->OrdPFecha))
                                echo $eliminarDatosProductos->OrdPFecha;                            
                            ...
                            <br>
                        <input class="form-control" placeholder="OrdPObservaciones" name="OrdPObservaciones" type="number"  required="required" readonly="readonly"
                            value="<?php
                            if (isset($eliminarDatosProductos->OrdPObservaciones))
                                echo $eliminarDatosProductos->OrdPObservaciones;                            
                ...
                <!--<input type="hidden" name="contenido" value="controlarRegistro">-->
                        ...
                        <button class="btn btn-info m-b-10 m-l-5 m-30" type="submit" >Eliminar venta</button>
